...
from ..utils.path import db_path, data_path, wordlist_path, corpus_path
from ..utils.regex import is_exact, regex_len, regex_slice
...
WORDS = Wordlist('wordfreq-1.6-en')
